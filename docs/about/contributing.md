...
If you would like to get involved with the Subcommittee, contact [Melanie Lorang](mailto:melanie.k.lorang@boeing.com).
...
and is created based on the source code found in the repository located <https://github.com/aiaa-deic/digthread>.
...
to raise an [issue](https://github.com/aiaa-deic/digthread/issues) in the repository
...
As above, if you have any problems, please raise an [issue](https://github.com/aiaa-deic/digthread/issues).
